...
# CIFAR-10 Dataset
train_dataset = torchvision.datasets.CIFAR10(root='/content/drive/MyDrive/osproj/data/',
                                             train=True,
                                             transform=transform_train,
                                             download=True) # Change Download-flag "True" at the first excution.

test_dataset = torchvision.datasets.CIFAR10(root='/content/drive/MyDrive/osproj/data/',
                                            train=False,
...
# PATH = '/content/resnet50_epoch285.ckpt'  # test acc would be almost 80

model = vgg16().to(device)
PATH = '/content/vgg16_epoch250.ckpt'  # test acc would be almost 85
##############################################################
